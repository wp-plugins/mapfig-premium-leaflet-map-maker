...
<section id="social plugin" class="wrapssss" >
	...
	<p class="style11">MapFig was created using OpenSource components such Leafletjs, BootStrap, and Font-Awesome.</p>
	<p class="style12">If you would like to view a video or read full documentation, please visit <a href="http://docs.mapfig.com/wordpress-premium-leaflet-plugin/" target="_blank">http://docs.mapfig.com/wordpress-premium-leaflet-plugin/</a>.</p>
	<p>&nbsp; </p>
