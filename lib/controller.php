...
function add_main_map() {
	...
	if(isset($post['submit'])){
		if(!isset($post['title']) || strlen($post['title']) == 0){
			...
			if($id == 0) {
				$wpdb->insert( $table_name, array( 'title' => $post['title'],'width' => (int)$width, 'height' => (int)$height, 'show_sidebar' =>(int)mapfig_premium__post('show_sidebar'), 'show_search' =>(int)mapfig_premium__post('show_search'), 'show_measure' =>(int)mapfig_premium__post('show_measure'), 'show_minimap' =>(int)mapfig_premium__post('show_minimap'), 'show_svg' =>(int)mapfig_premium__post('show_svg'), 'show_export' =>(int)mapfig_premium__post('show_export'), 'lat' => $lat, 'lng' => $lng, 'zoom' => (int)$zoom, 'data' => $data, 'layers_id' => (int)$post['layers_id'], 'groups_id' => (int)$post['groups_id']));
				...
				$wpdb->update( 
					$table_name, 
					array('title' => $post['title'],'width' => (int)$width, 'height' => (int)$height, 'show_sidebar' =>(int)mapfig_premium__post('show_sidebar'), 'show_search' =>(int)mapfig_premium__post('show_search'), 'show_measure' =>(int)mapfig_premium__post('show_measure'), 'show_minimap' =>(int)mapfig_premium__post('show_minimap'), 'show_svg' =>(int)mapfig_premium__post('show_svg'), 'show_export' =>(int)mapfig_premium__post('show_export'), 'lat' => $lat, 'lng' => $lng, 'zoom' => (int)$zoom, 'data' => $data, 'layers_id' => (int)$post['layers_id'], 'groups_id' => (int)$post['groups_id']), 
					array( 'mid' => $id )
				);
